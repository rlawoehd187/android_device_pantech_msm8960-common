...
char const*const RED_LED_FILE = "/sys/class/leds/red/brightness";//Not used
char const*const GREEN_LED_FILE = "/sys/class/leds/green/brightness";//Not used
char const*const BLUE_LED_FILE = "/sys/class/leds/blue/brightness";//Not used
char const*const LCD_FILE = "/sys/class/leds/lcd-backlight/brightness";
char const*const KEYBOARD_FILE = "/sys/class/leds/keyboard-backlight/brightness";//Not used
...
struct hw_module_t HAL_MODULE_INFO_SYM = {
    ...
    .author = "Le Hoang, icy.lord.love.angel@gmail.com",
